...
local function get_custom_snap_types()
	if internal_custom_entity_types == nil then
		internal_custom_entity_types = remote.call("bplib", "get_custom_snap_types")
	end
	return internal_custom_entity_types
end

local function get_custom_snap_names()
	if internal_custom_entity_names == nil then
		internal_custom_entity_names = remote.call("bplib", "get_custom_snap_names")
	end
...
local function get_custom_snap_info(eproto)
	...
	local type_info = get_custom_snap_types()[eproto.type]
