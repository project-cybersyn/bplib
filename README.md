...
---@field blueprint LuaItemStack|LuaRecord The blueprint that entities are being extracted into.
...
---@field blueprint LuaItemStack|LuaRecord The blueprint that is being applied.
